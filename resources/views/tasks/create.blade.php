            ...
            <form method="POST" action="{{ route('projects.tasks.store', $project) }}" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="descripcion" rows="3"
                              ...
                              placeholder="Describe la tarea...">{{ old('descripcion') }}</textarea>
                </div>
                    ...
                    <div>
                        ...
                        <select name="estado"
                            ...
                            @foreach (['pendiente', 'en_progreso', 'completada'] as $e)
                                <option value="{{ $e }}" @selected(old('estado', 'pendiente') === $e)>
                    ...
                    <div>
                        ...
                        <select name="assignee_id"
                            ...
                            @foreach ($members as $m)
                                <option value="{{ $m->id }}" @selected(old('assignee_id') == $m->id)>
                                    {{ $m->name }}
                                </option>
                            @endforeach
                        </select>
